...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
      ...
      @if($user->role == 'ادمن')
          ...
          <li><a class="app-menu__item  {{\Request::route()->getName() == 'student.report' ? 'active' : ''}}" href="{{ route('student.report') }}"><i class="app-menu__icon fa fa-industry"></i><span class="app-menu__label">تقرير الطلاب </span></a></li>
